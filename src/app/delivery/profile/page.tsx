    ...
    <div className="max-w-lg mx-auto space-y-6 pb-6">
      ...
      <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-slate-950 px-4 py-2 rounded-full border border-slate-800">
          ...
          <span className="text-sm font-bold text-slate-300">Driver ID: {profileId.substring(0, 8).toUpperCase()}</span>
        </div>
      </div>

      <div className="bg-slate-900 rounded-2xl border border-slate-800 overflow-hidden">
        <Link href="/delivery/settings" className="flex items-center justify-between p-4 border-b border-slate-800 hover:bg-slate-800/50 transition-colors">
        ...
        <Link href="#" className="flex items-center justify-between p-4 border-b border-slate-800 hover:bg-slate-800/50 transition-colors">
          <div className="flex items-center gap-3">
