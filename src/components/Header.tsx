    ...
    <header className="sticky top-0 z-40 bg-[#fbf9f4]/95 backdrop-blur-md border-b border-[#e6e2d8] shadow-2xs">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3 flex items-center justify-between gap-4 lg:gap-8">
        ...
        <div className="flex items-center gap-4 sm:gap-6 min-w-0">
          ...
          <Link
            href="/branches"
            className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-white border border-[#e6e2d8] hover:border-[#d4af37] transition text-xs font-semibold text-[#0d261e] truncate shadow-2xs group"
          >
            ...
            <div className="flex flex-col text-left leading-tight truncate">
              ...
              <span className="text-[10px] text-[#52635c] truncate max-w-[140px] sm:max-w-[190px]">
                {userLocation?.distanceKm !== undefined
                  ? `${userLocation.distanceKm} km · ${userLocation.etaMin || 20} mins ETA`
                  : branch.area}
              </span>
            </div>
          </Link>
        ...
        <div className="hidden lg:flex items-center gap-6 flex-1 max-w-2xl justify-center">
          ...
          <div className="flex-1 max-w-sm">
            ...
            >
              ...
              <span className="truncate">Search dishes, paneer, biryani...</span>
            </Link>
          </div>
        </div>
